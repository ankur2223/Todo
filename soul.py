...
TOKEN = '7402982061:AAEPmXdRYraqyhXyXQvKvUjW86StY6r57zA'
...
FORWARD_CHANNEL_ID = -1002210168139
CHANNEL_ID = -1002210168139
error_channel_id = -1002210168139
...
def handle_message(message):
    if message.text == "Instant Plan 🍌":
        ...
        bot.reply_to(message, "*Contact admin @todo_v8*", parse_mode='Markdown')
    else:
